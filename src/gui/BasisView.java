...
public class BasisView {
	...
	private void initKomponenten() {
		...
		pane.getChildren().addAll(btnLeseMessungenAusDB, btnHoleMessungVonEMU, btnStarteMessreihe, btnStoppeMessreihe);
	}
	...
	private void initListener() {
		...
		btnHoleMessungVonEMU.setOnAction(aEvent -> {
			txtAnzeige.setText(basisControl.holeMessungVonEMU(txtMessreihenId.getText(), txtLaufendeNummer.getText())
					.gibAttributeAus());
		});
	}
